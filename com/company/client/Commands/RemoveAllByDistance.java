...
public class RemoveAllByDistance implements Command{
    ...
    public  RemoveAllByDistance(Connection connection){
    ...
    public String getDescription() {
        return "удалить из коллекции все элементы, значение поля distance которого эквивалентно заданномуй / remove_distance";
    }
