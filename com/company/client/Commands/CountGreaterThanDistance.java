...
/**
 * Посчитать количество элементов, поле distance которых больше, чем заданный
 */
public class CountGreaterThanDistance implements Command{
    private Connection connection;

    public  CountGreaterThanDistance(Connection connection){
    ...
    public String getDescription() {
        return "Посчитать количество элементов больше, чем заданный / count_greater";
    }
